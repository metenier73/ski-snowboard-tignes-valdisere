        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <div id="weather-tignes" className="text-gray-700">Prévisions intégrées côté client via Open-Meteo.</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <div id="weather-val" className="text-gray-700">Prévisions intégrées côté client via Open-Meteo.</div>
              </CardContent>
            </Card>
          </div>
