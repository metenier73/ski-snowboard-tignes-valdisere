              ...
              >
                {item.id === 'home' ? (
                  <div className="relative">
                    ...
                    >
                      <a href="#home" onClick={handleMenuItemClick} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <Home className="h-4 w-4 text-blue-600" />
                        <span>Accueil</span>
                      </a>
                      <div className="my-1 border-t border-gray-100" />
                      <a href="#about" onClick={handleMenuItemClick} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <Info className="h-4 w-4 text-gray-600" />
                        <span>{t.nav.about}</span>
                      </a>
                      <a href="#gallery" onClick={handleMenuItemClick} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                  ...
                  <div className="relative">
                    ...
                    >
                      <a href="#services" onClick={handleMenuItemClick} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <Settings className="h-4 w-4 text-gray-600" />
                        <span>Tous les services</span>
                      </a>
                      <a href="#blog" onClick={handleMenuItemClick} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <BookOpen className="h-4 w-4 text-gray-600" />
                        <span>{t.nav.blog}</span>
                      </a>
                      <div className="my-1 border-t border-gray-100" />
                      <a href="#weather" onClick={handleMenuItemClick} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <CloudSun className="h-4 w-4 text-blue-600" />
                        <span>Prévisions météo</span>
                      </a>
                      <a href="#avalanche" onClick={handleMenuItemClick} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
